            ...
            <!-- ENTRADA PARA LA DESCRIPCIÓN -->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control input-lg" name="nuevoStock" step="any" min="0" placeholder="Stock" required>
            ...
            <!-- ENTRADA PARA LA DESCRIPCIÓN -->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control input-lg" id="editarStock" step="any" name="editarStock" required>
